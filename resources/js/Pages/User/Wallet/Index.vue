<template>
    <div class="container mx-auto">
        ...
        <div class="flex gap-x-1 justify-end mt-2">
            ...
            <Button color="primary">My transactions</Button>
            </Link>
        </div>
    ...
    <form @submit.prevent="createNewTransaction">
        ...
        <div>
            ...
            <textarea v-model="formData.note" class="w-full rounded-md p-2 bg-white border border-gray-300"></textarea>
        ...
        <div>
            ...
            <select v-model="formData.category_id" class="w-full rounded-md p-2 bg-white border border-gray-300">
                <option v-for="category in filteredCategories" :key="category.id" :value="category.id">
                    {{ category.title }}
                </option>
            </select>
            <p v-if="errors.category_id" class="mt-1 text-sm text-red-600 dark:text-red-500">{{ errors.category_id }}</p>
        </div>
...
<script setup>
const props = defineProps({ walletBalance: String, categories: Array, totalIncome: String, totalExpenses: String, userTransactions: Object, errors: Object })
